...
# Load raw data
test <- read.csv("https://raw.githubusercontent.com/EasyD/IntroToDataScience/master/test.csv", header = TRUE)
train <- read.csv("https://raw.githubusercontent.com/EasyD/IntroToDataScience/master/train.csv", header = TRUE)
